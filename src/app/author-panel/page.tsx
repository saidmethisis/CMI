...
export default async function AuthorPanelPage() {
  ...
  const articles = mine.map((a) => ({ id: a.id, slug: a.slug, title: a.title, lead: a.lead, body: a.body, categorySlug: a.categorySlug, status: a.status, createdAt: a.createdAt, views: a.views, translations: a.translations ?? {} }));
  return (
