    ...
    <LegalShell title={t("lg.legalTitle")}>
      ...
      <table className="w-full text-sm">
        <tbody className="[&_td]:border-t [&_td]:border-black/5 [&_td]:py-2.5 dark:[&_td]:border-white/10 [&_td:first-child]:w-1/3 [&_td:first-child]:font-semibold">
          ...
          <tr><td>{t("lg.legalFounder")}</td><td>{ORG.founder}</td></tr>
          <tr><td>{t("lg.legalEditor")}</td><td>{ORG.editor}</td></tr>
          <tr><td>{t("lg.legalAddress")}</td><td>{ORG.address}</td></tr>
          <tr><td>{t("lg.legalEmail")}</td><td>{ORG.email}</td></tr>
          <tr><td>{t("ap.phone")}</td><td>{ORG.phone}</td></tr>
          <tr><td>{t("lg.legalSmiCert")}</td><td>{ORG.smiCert}</td></tr>
