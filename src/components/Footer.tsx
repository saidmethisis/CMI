...
export default function Footer() {
  ...
  return (
    <footer className="border-t border-black/5 bg-black/[0.02] pb-20 dark:border-white/10 dark:bg-white/[0.02] md:pb-0">
      ...
      <div className="border-t border-black/5 dark:border-white/10">
        <div className="container-content flex flex-col gap-2 py-4 text-xs text-black/50 sm:flex-row sm:items-center sm:justify-between dark:text-white/50">
          ...
          <div className="flex flex-wrap items-center gap-x-4 gap-y-1">
            ...
            <Link href="/for-companies" className="font-semibold text-accent hover:underline">{t("header.promo")}</Link>
